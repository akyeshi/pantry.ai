        ...
        <>
            <Box width="100vw" height="100vh" display="flex"  alignItems="center" gap={2} flexDirection="column">
                ...
                <Box display="flex"  alignItems="center" gap={2} flexDirection="column">
                    <Typography variant="h2" sx={{fontWeight: "bold"}}>Welcome to Pantry.ai</Typography>
                    <Stack direction="row" spacing={5} width="100%" height="100%" marginTop="75px" display="flex" justifyContent={"center"} alignItems="center">
                        <Card sx={{marginLeft: "10px !important", width:"80% !important", height: "40vh", boxShadow: 5, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 3, p: 5}} overflow="auto" > 
                        ...
                        <Card sx={{width:"80% !important", height: "40vh", boxShadow: 5, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 3, p: 5}} overflow="auto">
                        ...
                        <Card sx={{marginRight: "10px !important", width:"80% !important", height: "40vh", boxShadow: 5, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: 3, p: 5}} overflow="auto">
